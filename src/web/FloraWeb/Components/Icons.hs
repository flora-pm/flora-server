...
pen =
  toHtmlRaw @Text
    [str|
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width="24" height="24" stroke-width="1.5" stroke="currentColor" class="pen">
...
lookingGlass =
  toHtmlRaw @Text
    [str|
<svg xmlns="http://www.w3.org/2000/svg" style="color: gray" fill="none" viewBox="0 0 24 24" width="24" height="24" stroke="currentColor">
